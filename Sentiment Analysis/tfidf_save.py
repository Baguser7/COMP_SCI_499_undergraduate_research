...
if __name__ == '__main__':
    data=r".\COMP_SCI_499_undergraduate_research\Dataset Updated\tox_class_updt.csv"
    df = pd.read_csv(data)
    ...
    joblib.dump(vectorizer.vocabulary_,open(r".\COMP_SCI_499_undergraduate_research\Sentiment Analysis\vectorizer.model","wb"))
