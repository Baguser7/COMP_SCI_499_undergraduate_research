...
fd = pd.read_csv(r".\COMP_SCI_499_undergraduate_research\Dataset\tox_class.csv")  

# for n in df.columns:
#     data['text'] = df['text']
#     data['value'] = df['severity_rating']
fd = fd.head(1000)
for index, n in enumerate(fd.columns):
...
udt2.to_csv(r".\COMP_SCI_499_undergraduate_research\Dataset Updated\tox_class_updt.csv", index=False) 
